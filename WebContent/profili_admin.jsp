...
<%@ page
	import="admin_package.UserDatabase3,admin_package.User3,student_login.ConnectionPro"%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<%
		...
		User3 user3= (User3) session.getAttribute("logUser3");
	%>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="profile-img">
					<img src="${pageContext.request.contextPath}/img/login/admin_avatar.png"
				...
				<div class="tab-content profile-tab" id="myTabContent">
					<div class="tab-pane fade show active" id="profili" role="tabpanel"
						...
						<div class="row">
							...
							<div class="col-md-7">
								<label><%=user3.getEmail3() %></label>
							</div>
						</div>
					</div>
					<div class="tab-pane fade" id="ndrysho_pass" role="tabpanel"
						aria-labelledby="profile-tab">
						<form action="PasswordAdmin" method="post" autoComplete="off">
							<div class="row">
								<div class="col-md-5">
							...
							<div class="row">
								...
								<input type="hidden" name="email_pass" value="<%= user3.getEmail3() %>">
							</div>
							<div class="row">
