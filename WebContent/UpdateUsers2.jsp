...
<%
	...
	UserDatabase2 udb = new UserDatabase2(ConnectionPro.getConnection());
	User2 pdgUpd = udb.IdUser2(idP);
...
<body>
	...
	<div class="container">
		<c:if test=""></c:if>
		<h3>Ndrysho te dhenat e Pedagogut</h3>
		<h5>
			Pedagog Id :
			<%=pdgUpd.getId2()%></h5>
		<div class="row">
			<form class="col s6" action="EditPedagog" method="post"
				id="UpdateUsersForm" novalidate>
				<div class="row">
					<div class="input-field col s6">
						<input type="hidden" name="UpdId" value="<%=pdgUpd.getId2()%>">
						<label for="firstName">Emer</label> <input type="text"
							name="Emri" id="firstName" value="<%=pdgUpd.getName2()%>"
							onchange="validateFirstName()" /> <span class="helper-text"></span>
					</div>
					<div class="input-field col s6">
						<label for="lastName">Mbiemer</label> <input type="text"
							name="Mbiemri" id="lastName" value="<%=pdgUpd.getSurname2()%>"
				...
				<div class="row">
					<div class="input-field col s6">
						<label for="password">Fjalekalimi</label> <input type="password"
							name="Fjalekalimi" id="password" onchange="validatePassword()"
							value="<%=pdgUpd.getPassword2()%>" /> <span class="helper-text"></span>
					</div>
					<div class="input-field col s6">
						<label for="confirmPassword">Konfirmo fjalekalimin</label> <input
							type="password" name="Fjalekalimi2" id="confirmPassword"
							value="<%=pdgUpd.getPassword2()%>"
				...
				<div class="row">
					<div class="input-field col s12">
						<label for="email">Email</label> <input type="email"
							name="Email" id="email" value="<%=pdgUpd.getEmail2()%>"
