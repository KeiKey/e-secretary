...
%>
	...
	<div class="container">
		<div class="box">
			<img class="avatar" src="img/login/pedagog_avatar.png">
			<h1>
				Llogaria<br> Pedagog
			</h1>
			<form action="LoginServletPedagog" method="post" autoComplete="off">
				<p>Email</p>
				<input type="text" placeholder="Email" name="email" required>
				<p>Fjalekalimi</p>
				<input type="password" placeholder="Fjalekalimi" name="password"
					required> <input type="submit" value="Kycuni"> <a
					href="login_student.jsp" style="text-decoration: none;">Student?</a>
				<br> <a href="login_admin.jsp" style="text-decoration: none;">Admin?</a>
			</form>
		</div>
	</div>
</body>
