...
<%@page import="student_login.User"%>
...
<link href="css/llogaria_container.css" rel="stylesheet" type="text/css" />
<link rel="icon"
...
<style type="text/css">
<!--
stilizimi i welcome info -->.container-fluid input {
	width: 100%;
	border-radius: 10px;
}
		...
		<table class="table table-hover ">
			...
			<tbody>
				<tr class="table-success text-dark">
					<td >Programim Web</td>
					<td>Ana Dhembi/Arlinda Profi</td>
					<td>6</td>
				</tr>
				<tr class="">
					<td>GIS</td>
					<td>Ana Dhembi/Alketa Guxha</td>
					<td>-</td>
				</tr>
				...
				<tr class="">
					<td>Inxhinieri Softi</td>
					<td>Jonida Shehu</td>
					<td>-</td>
				</tr>
				<tr class="table-danger text-dark">
					<td>Strukture te Dhenash</td>
					<td>Denis Saatciu</td>
					<td>4</td>
				</tr>
				<tr class="">
					<td>Sisteme Operimi</td>
					<td>Denada Xhaja</td>
					<td>-</td>
				</tr>
				<tr class="table-success text-dark">
					<td>Rrjetat</td>
					<td>Julian Fejzaj/Gerild Qordja</td>
					<td>7</td>
				</tr>
