...
<%@ page
	import="pedagog_login.UserDatabase2,pedagog_login.User2,student_login.ConnectionPro"%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<%
		...
		User2 user2 = (User2) session.getAttribute("logUser2");
	%>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="profile-img">
					<img
						src="${pageContext.request.contextPath}/img/login/pedagog_avatar.png"
			...
			<div class="col-md-6">
				<div class="profile-head">
					...
					<h6>Pedagog</h6>
					<br>
					<h6>Departamenti i Informatikes</h6>
					<br>
				...
				<div class="tab-content profile-tab" id="myTabContent">
					<div class="tab-pane fade show active" id="profili" role="tabpanel"
						...
						<div class="row">
							...
							<div class="col-md-7">
								<label><%=user2.getEmail2() %></label>
							</div>
						</div>
					</div>
					<div class="tab-pane fade" id="ndrysho_pass" role="tabpanel"
						aria-labelledby="profile-tab">
						<form action="PasswordPedagog" method="post" autoComplete="off">
							<div class="row">
								<div class="col-md-5">
							...
							<div class="row">
								...
								<input type="hidden" name="email_pass" value="<%= user2.getEmail2() %>">
							</div>
							<div class="row">
								<div class="col-7">
									<p><%=session.getAttribute("JSP") %></p>
								</div>
								<div class="col-2">
